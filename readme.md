...
## 5. Тестовые данные для проверяющего (Вариант №2)

В базе данных уже созданы тестовые пользователи. Вы можете использовать их для проверки функционала приложения:

* **Администратор:** `admin@test.ru` | Пароль: `admin`
* **Пользователь 1:** `ivan@test.ru` | Пароль: `ivan`
* **Пользователь 2:** `petr@petr.ru` | Пароль: `petr`